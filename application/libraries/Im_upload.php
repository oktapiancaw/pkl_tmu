...
class Im_upload{
	function __construct(){
		...
		$this->allowed_types	= 'jpeg|jpg|png|bmp|doc|docx|xls|xlsx|ppt|pptx|pdf|sql|zip|rar|swf|flv|mp4';
	}
	
	function uploading($form_file = NULL, $name_foto = NULL, $format = 'etc'){
		...
		if($form_file != NULL){
			...
			if ($this->CI->upload->do_upload($form_file)){
				...
				$upload_data = str_replace(" ", "_", $upload_data['file_name']);
				return $upload_data;
